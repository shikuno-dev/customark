...
pub fn find_character_for_html_entity(input: &str) -> Option<&'static str> {
    ...
    match input {
        ...
        "Acirc" => Some("\u{00C2}"),
        "Acy" => Some("\u{0410}"),
        "Afr" => Some("\u{1D504}"), // "Afr" => Some("\u{D835}\u{DD04}"),
        "Agrave" => Some("\u{00C0}"),
        "Alpha" => Some("\u{0391}"),
        "Amacr" => Some("\u{0100}"),
        "And" => Some("\u{2A53}"),
        "Aogon" => Some("\u{0104}"),
        "Aopf" => Some("\u{1D538}"), // "Aopf" => Some("\u{D835}\u{DD38}"),
        "ApplyFunction" => Some("\u{2061}"),
        "Aring" => Some("\u{00C5}"),
        "Ascr" => Some("\u{1D49C}"), // "Ascr" => Some("\u{D835}\u{DC9C}"),
        "Assign" => Some("\u{2254}"),
        "Atilde" => Some("\u{00C3}"),
        "Auml" => Some("\u{00C4}"),
        ...
        "Beta" => Some("\u{0392}"),
        "Bfr" => Some("\u{1D505}"),  // "Bfr" => Some("\u{D835}\u{DD05}"),
        "Bopf" => Some("\u{1D539}"), // "Bopf" => Some("\u{D835}\u{DD39}"),
        "Breve" => Some("\u{02D8}"),
        "Bscr" => Some("\u{212C}"),
        "Bumpeq" => Some("\u{224E}"),
        "CHcy" => Some("\u{0427}"),
        ...
        "Cross" => Some("\u{2A2F}"),
        "Cscr" => Some("\u{1D49E}"), // "Cscr" => Some("\u{D835}\u{DC9E}"),
        "Cup" => Some("\u{22D3}"),
        "CupCap" => Some("\u{224D}"),
        "DD" => Some("\u{2145}"),
        ...
        "Del" => Some("\u{2207}"),
        "Delta" => Some("\u{0394}"),
        "Dfr" => Some("\u{1D507}"), // "Dfr" => Some("\u{D835}\u{DD07}"),
        ...
        "Dopf" => Some("\u{1D53B}"), // "Dopf" => Some("\u{D835}\u{DD3B}"),
        "Dot" => Some("\u{00A8}"),
        "DotDot" => Some("\u{20DC}"),
        ...
        "Dscr" => Some("\u{1D49F}"), // "Dscr" => Some("\u{D835}\u{DC9F}"),
        "Dstrok" => Some("\u{0110}"),
        "ENG" => Some("\u{014A}"),
        "ETH" => Some("\u{00D0}"),
        "Eacute" => Some("\u{00C9}"),
        ...
        "Ecy" => Some("\u{042D}"),
        "Edot" => Some("\u{0116}"),
        "Efr" => Some("\u{1D508}"), // "Efr" => Some("\u{D835}\u{DD08}"),
        "Egrave" => Some("\u{00C8}"),
        "Element" => Some("\u{2208}"),
        "Emacr" => Some("\u{0112}"),
        ...
        "Eogon" => Some("\u{0118}"),
        "Eopf" => Some("\u{1D53C}"), // "Eopf" => Some("\u{D835}\u{DD3C}"),
        "Epsilon" => Some("\u{0395}"),
        "Equal" => Some("\u{2A75}"),
        ...
        "Fcy" => Some("\u{0424}"),
        "Ffr" => Some("\u{1D509}"), // "Ffr" => Some("\u{D835}\u{DD09}"),
        "FilledSmallSquare" => Some("\u{25FC}"),
        "FilledVerySmallSquare" => Some("\u{25AA}"),
        "Fopf" => Some("\u{1D53D}"), // "Fopf" => Some("\u{D835}\u{DD3D}"),
        "ForAll" => Some("\u{2200}"),
        ...
        "Gcy" => Some("\u{0413}"),
        "Gdot" => Some("\u{0120}"),
        "Gfr" => Some("\u{1D50A}"), // "Gfr" => Some("\u{D835}\u{DD0A}"),
        "Gg" => Some("\u{22D9}"),
        "Gopf" => Some("\u{1D53E}"), // "Gopf" => Some("\u{D835}\u{DD3E}"),
        ...
        "Gscr" => Some("\u{1D4A2}"), // "Gscr" => Some("\u{D835}\u{DCA2}"),
        "Gt" => Some("\u{226B}"),
        "HARDcy" => Some("\u{042A}"),
        "Hacek" => Some("\u{02C7}"),
        "Hat" => Some("\u{005E}"),
        ...
        "Iogon" => Some("\u{012E}"),
        "Iopf" => Some("\u{1D540}"), // "Iopf" => Some("\u{D835}\u{DD40}"),
        "Iota" => Some("\u{0399}"),
        "Iscr" => Some("\u{2110}"),
        "Itilde" => Some("\u{0128}"),
        "Iukcy" => Some("\u{0406}"),
        ...
        "Jcirc" => Some("\u{0134}"),
        "Jcy" => Some("\u{0419}"),
        "Jfr" => Some("\u{1D50D}"),  // "Jfr" => Some("\u{D835}\u{DD0D}"),
        "Jopf" => Some("\u{1D541}"), // "Jopf" => Some("\u{D835}\u{DD41}"),
        "Jscr" => Some("\u{1D4A5}"), // "Jscr" => Some("\u{D835}\u{DCA5}"),
        "Jsercy" => Some("\u{0408}"),
        "Jukcy" => Some("\u{0404}"),
        "KHcy" => Some("\u{0425}"),
        "KJcy" => Some("\u{040C}"),
        ...
        "Kcedil" => Some("\u{0136}"),
        "Kcy" => Some("\u{041A}"),
        "Kfr" => Some("\u{1D50E}"),  // "Kfr" => Some("\u{D835}\u{DD0E}"),
        "Kopf" => Some("\u{1D542}"), // "Kopf" => Some("\u{D835}\u{DD42}"),
        "Kscr" => Some("\u{1D4A6}"), // "Kscr" => Some("\u{D835}\u{DCA6}"),
        "LJcy" => Some("\u{0409}"),
        "LT" => Some("\u{003C}"),
        "Lacute" => Some("\u{0139}"),
        "Lambda" => Some("\u{039B}"),
        ...
        "Lfr" => Some("\u{1D50F}"), // "Lfr" => Some("\u{D835}\u{DD0F}"),
        "Ll" => Some("\u{22D8}"),
        ...
        "Lopf" => Some("\u{1D543}"), // "Lopf" => Some("\u{D835}\u{DD43}"),
        ...
        "Mfr" => Some("\u{1D510}"), // "Mfr" => Some("\u{D835}\u{DD10}"),
        "MinusPlus" => Some("\u{2213}"),
        "Mopf" => Some("\u{1D544}"), // "Mopf" => Some("\u{D835}\u{DD44}"),
        "Mscr" => Some("\u{2133}"),
        "Mu" => Some("\u{039C}"),
        "NJcy" => Some("\u{040A}"),
        "Nacute" => Some("\u{0143}"),
        ...
        "NewLine" => Some("\u{000A}"),
        "Nfr" => Some("\u{1D511}"), // "Nfr" => Some("\u{D835}\u{DD11}"),
        "NoBreak" => Some("\u{2060}"),
        ...
        "Nscr" => Some("\u{1D4A9}"), // "Nscr" => Some("\u{D835}\u{DCA9}"),
        "Ntilde" => Some("\u{00D1}"),
        "Nu" => Some("\u{039D}"),
        "OElig" => Some("\u{0152}"),
        "Oacute" => Some("\u{00D3}"),
        ...
        "Ocy" => Some("\u{041E}"),
        "Odblac" => Some("\u{0150}"),
        "Ofr" => Some("\u{1D512}"), // "Ofr" => Some("\u{D835}\u{DD12}"),
        "Ograve" => Some("\u{00D2}"),
        "Omacr" => Some("\u{014C}"),
        "Omega" => Some("\u{03A9}"),
        "Omicron" => Some("\u{039F}"),
        "Oopf" => Some("\u{1D546}"), // "Oopf" => Some("\u{D835}\u{DD46}"),
        "OpenCurlyDoubleQuote" => Some("\u{201C}"),
        "OpenCurlyQuote" => Some("\u{2018}"),
        "Or" => Some("\u{2A54}"),
        "Oscr" => Some("\u{1D4AA}"), // "Oscr" => Some("\u{D835}\u{DCAA}"),
        "Oslash" => Some("\u{00D8}"),
        "Otilde" => Some("\u{00D5}"),
        "Otimes" => Some("\u{2A37}"),
        "Ouml" => Some("\u{00D6}"),
        ...
        "Pcy" => Some("\u{041F}"),
        "Pfr" => Some("\u{1D513}"), // "Pfr" => Some("\u{D835}\u{DD13}"),
        "Phi" => Some("\u{03A6}"),
        "Pi" => Some("\u{03A0}"),
        ...
        "Pscr" => Some("\u{1D4AB}"), // "Pscr" => Some("\u{D835}\u{DCAB}"),
        "Psi" => Some("\u{03A8}"),
        "QUOT" => Some("\u{0022}"),
        "Qfr" => Some("\u{1D514}"), // "Qfr" => Some("\u{D835}\u{DD14}"),
        "Qopf" => Some("\u{211A}"),
        "Qscr" => Some("\u{1D4AC}"), // "Qscr" => Some("\u{D835}\u{DCAC}"), // \u{1D4AC}
        "RBarr" => Some("\u{2910}"),
        "REG" => Some("\u{00AE}"),
        "Racute" => Some("\u{0154}"),
        "Rang" => Some("\u{27EB}"),
        ...
        "Scirc" => Some("\u{015C}"),
        "Scy" => Some("\u{0421}"),
        "Sfr" => Some("\u{1D516}"), // "Sfr" => Some("\u{D835}\u{DD16}"),
        ...
        "Sopf" => Some("\u{1D54A}"), // "Sopf" => Some("\u{D835}\u{DD4A}"),
        "Sqrt" => Some("\u{221A}"),
        "Square" => Some("\u{25A1}"),
        ...
        "Sscr" => Some("\u{1D4AE}"), // "Sscr" => Some("\u{D835}\u{DCAE}"),
        "Star" => Some("\u{22C6}"),
        "Sub" => Some("\u{22D0}"),
        "Subset" => Some("\u{22D0}"),
        ...
        "Tcedil" => Some("\u{0162}"),
        "Tcy" => Some("\u{0422}"),
        "Tfr" => Some("\u{1D517}"), // "Tfr" => Some("\u{D835}\u{DD17}"),
        ...
        "Topf" => Some("\u{1D54B}"), // "Topf" => Some("\u{D835}\u{DD4B}"),
        "TripleDot" => Some("\u{20DB}"),
        "Tscr" => Some("\u{1D4AF}"), // "Tscr" => Some("\u{D835}\u{DCAF}"),
        "Tstrok" => Some("\u{0166}"),
        "Uacute" => Some("\u{00DA}"),
        "Uarr" => Some("\u{219F}"),
        ...
        "Ucy" => Some("\u{0423}"),
        "Udblac" => Some("\u{0170}"),
        "Ufr" => Some("\u{1D518}"), // "Ufr" => Some("\u{D835}\u{DD18}"),
        "Ugrave" => Some("\u{00D9}"),
        "Umacr" => Some("\u{016A}"),
        ...
        "Uogon" => Some("\u{0172}"),
        "Uopf" => Some("\u{1D54C}"), // "Uopf" => Some("\u{D835}\u{DD4C}"),
        "UpArrow" => Some("\u{2191}"),
        ...
        "Upsilon" => Some("\u{03A5}"),
        "Uring" => Some("\u{016E}"),
        "Uscr" => Some("\u{1D4B0}"), // "Uscr" => Some("\u{D835}\u{DCB0}"),
        "Utilde" => Some("\u{0168}"),
        "Uuml" => Some("\u{00DC}"),
        "VDash" => Some("\u{22AB}"),
        "Vbar" => Some("\u{2AEB}"),
        ...
        "Vfr" => Some("\u{1D519}"),  // "Vfr" => Some("\u{D835}\u{DD19}"),
        "Vopf" => Some("\u{1D54D}"), // "Vopf" => Some("\u{D835}\u{DD4D}"),
        "Vscr" => Some("\u{1D4B1}"), // "Vscr" => Some("\u{D835}\u{DCB1}"),
        "Vvdash" => Some("\u{22AA}"),
        "Wcirc" => Some("\u{0174}"),
        "Wedge" => Some("\u{22C0}"),
        "Wfr" => Some("\u{1D51A}"),  // "Wfr" => Some("\u{D835}\u{DD1A}"),
        "Wopf" => Some("\u{1D54E}"), // "Wopf" => Some("\u{D835}\u{DD4E}"),
        "Wscr" => Some("\u{1D4B2}"), // "Wscr" => Some("\u{D835}\u{DCB2}"),
        "Xfr" => Some("\u{1D51B}"),  // "Xfr" => Some("\u{D835}\u{DD1B}"),
        "Xi" => Some("\u{039E}"),
        "Xopf" => Some("\u{1D54F}"), // "Xopf" => Some("\u{D835}\u{DD4F}"),
        "Xscr" => Some("\u{1D4B3}"), // "Xscr" => Some("\u{D835}\u{DCB3}"),
        "YAcy" => Some("\u{042F}"),
        "YIcy" => Some("\u{0407}"),
        "YUcy" => Some("\u{042E}"),
        "Yacute" => Some("\u{00DD}"),
        "Ycirc" => Some("\u{0176}"),
        "Ycy" => Some("\u{042B}"),
        "Yfr" => Some("\u{1D51C}"),  // "Yfr" => Some("\u{D835}\u{DD1C}"),
        "Yopf" => Some("\u{1D550}"), // "Yopf" => Some("\u{D835}\u{DD50}"),
        "Yscr" => Some("\u{1D4B4}"), // "Yscr" => Some("\u{D835}\u{DCB4}"), // \u{1D4B4}
        "Yuml" => Some("\u{0178}"),
        "ZHcy" => Some("\u{0416}"),
        "Zacute" => Some("\u{0179}"),
        "Zcaron" => Some("\u{017D}"),
        ...
        "Zfr" => Some("\u{2128}"),
        "Zopf" => Some("\u{2124}"),
        "Zscr" => Some("\u{1D4B5}"), // "Zscr" => Some("\u{D835}\u{DCB5}"),
        "aacute" => Some("\u{00E1}"),
        "abreve" => Some("\u{0103}"),
        "ac" => Some("\u{223E}"),
        ...
        "aelig" => Some("\u{00E6}"),
        "af" => Some("\u{2061}"),
        "afr" => Some("\u{1D51E}"), // "afr" => Some("\u{D835}\u{DD1E}"),
        "agrave" => Some("\u{00E0}"),
        "alefsym" => Some("\u{2135}"),
        "aleph" => Some("\u{2135}"),
        "alpha" => Some("\u{03B1}"),
        ...
        "angzarr" => Some("\u{237C}"),
        "aogon" => Some("\u{0105}"),
        "aopf" => Some("\u{1D552}"), // "aopf" => Some("\u{D835}\u{DD52}"),
        "ap" => Some("\u{2248}"),
        "apE" => Some("\u{2A70}"),
        "apacir" => Some("\u{2A6F}"),
        "ape" => Some("\u{224A}"),
        ...
        "aring" => Some("\u{00E5}"),
        "ascr" => Some("\u{1D4B6}"), // "ascr" => Some("\u{D835}\u{DCB6}"),
        "ast" => Some("\u{002A}"),
        "asymp" => Some("\u{2248}"),
        "asympeq" => Some("\u{224D}"),
        "atilde" => Some("\u{00E3}"),
        ...
        "beth" => Some("\u{2136}"),
        "between" => Some("\u{226C}"),
        "bfr" => Some("\u{1D51F}"), // "bfr" => Some("\u{D835}\u{DD1F}"),
        "bigcap" => Some("\u{22C2}"),
        "bigcirc" => Some("\u{25EF}"),
        "bigcup" => Some("\u{22C3}"),
        "bigodot" => Some("\u{2A00}"),
        ...
        "bnot" => Some("\u{2310}"),
        "bopf" => Some("\u{1D553}"), // "bopf" => Some("\u{D835}\u{DD53}"),
        "bot" => Some("\u{22A5}"),
        "bottom" => Some("\u{22A5}"),
        "bowtie" => Some("\u{22C8}"),
        "boxDL" => Some("\u{2557}"),
        ...
        "breve" => Some("\u{02D8}"),
        "brvbar" => Some("\u{00A6}"),
        "bscr" => Some("\u{1D4B7}"), // "bscr" => Some("\u{D835}\u{DCB7}"),
        "bsemi" => Some("\u{204F}"),
        "bsim" => Some("\u{223D}"),
        "bsime" => Some("\u{22CD}"),
        "bsol" => Some("\u{005C}"),
        ...
        "cent" => Some("\u{00A2}"),
        "centerdot" => Some("\u{00B7}"),
        "cfr" => Some("\u{1D520}"), // "cfr" => Some("\u{D835}\u{DD20}"),
        "chcy" => Some("\u{0447}"),
        "check" => Some("\u{2713}"),
        ...
        "congdot" => Some("\u{2A6D}"),
        "conint" => Some("\u{222E}"),
        "copf" => Some("\u{1D554}"), // "copf" => Some("\u{D835}\u{DD54}"),
        "coprod" => Some("\u{2210}"),
        "copy" => Some("\u{00A9}"),
        "copysr" => Some("\u{2117}"),
        "crarr" => Some("\u{21B5}"),
        "cross" => Some("\u{2717}"),
        "cscr" => Some("\u{1D4B8}"), // "cscr" => Some("\u{D835}\u{DCB8}"),
        "csub" => Some("\u{2ACF}"),
        "csube" => Some("\u{2AD1}"),
        "csup" => Some("\u{2AD0}"),
        "csupe" => Some("\u{2AD2}"),
        ...
        "demptyv" => Some("\u{29B1}"),
        "dfisht" => Some("\u{297F}"),
        "dfr" => Some("\u{1D521}"), // "dfr" => Some("\u{D835}\u{DD21}"),
        "dharl" => Some("\u{21C3}"),
        "dharr" => Some("\u{21C2}"),
        "diam" => Some("\u{22C4}"),
        "diamond" => Some("\u{22C4}"),
        ...
        "dlcrop" => Some("\u{230D}"),
        "dollar" => Some("\u{0024}"),
        "dopf" => Some("\u{1D555}"), // "dopf" => Some("\u{D835}\u{DD55}"),
        "dot" => Some("\u{02D9}"),
        "doteq" => Some("\u{2250}"),
        ...
        "drcorn" => Some("\u{231F}"),
        "drcrop" => Some("\u{230C}"),
        "dscr" => Some("\u{1D4B9}"), // "dscr" => Some("\u{D835}\u{DCB9}"),
        "dscy" => Some("\u{0455}"),
        "dsol" => Some("\u{29F6}"),
        "dstrok" => Some("\u{0111}"),
        "dtdot" => Some("\u{22F1}"),
        ...
        "ee" => Some("\u{2147}"),
        "efDot" => Some("\u{2252}"),
        "efr" => Some("\u{1D522}"), // "efr" => Some("\u{D835}\u{DD22}"),
        "eg" => Some("\u{2A9A}"),
        "egrave" => Some("\u{00E8}"),
        "egs" => Some("\u{2A96}"),
        "egsdot" => Some("\u{2A98}"),
        ...
        "ensp" => Some("\u{2002}"),
        "eogon" => Some("\u{0119}"),
        "eopf" => Some("\u{1D556}"), // "eopf" => Some("\u{D835}\u{DD56}"),
        "epar" => Some("\u{22D5}"),
        "eparsl" => Some("\u{29E3}"),
        "eplus" => Some("\u{2A71}"),
        "epsi" => Some("\u{03B5}"),
        ...
        "fflig" => Some("\u{FB00}"),
        "ffllig" => Some("\u{FB04}"),
        "ffr" => Some("\u{1D523}"), // "ffr" => Some("\u{D835}\u{DD23}"),
        "filig" => Some("\u{FB01}"),
        ...
        "fltns" => Some("\u{25B1}"),
        "fnof" => Some("\u{0192}"),
        "fopf" => Some("\u{1D557}"), // "fopf" => Some("\u{D835}\u{DD57}"),
        "forall" => Some("\u{2200}"),
        "fork" => Some("\u{22D4}"),
        "forkv" => Some("\u{2AD9}"),
        ...
        "frasl" => Some("\u{2044}"),
        "frown" => Some("\u{2322}"),
        "fscr" => Some("\u{1D4BB}"), // "fscr" => Some("\u{D835}\u{DCBB}"), // \u{1D4BB}
        "gE" => Some("\u{2267}"),
        "gEl" => Some("\u{2A8C}"),
        "gacute" => Some("\u{01F5}"),
        "gamma" => Some("\u{03B3}"),
        ...
        "gesles" => Some("\u{2A94}"),
        "gfr" => Some("\u{1D524}"), // "gfr" => Some("\u{D835}\u{DD24}"),
        "gg" => Some("\u{226B}"),
        "ggg" => Some("\u{22D9}"),
        "gimel" => Some("\u{2137}"),
        "gjcy" => Some("\u{0453}"),
        ...
        "gneqq" => Some("\u{2269}"),
        "gnsim" => Some("\u{22E7}"),
        "gopf" => Some("\u{1D558}"), // "gopf" => Some("\u{D835}\u{DD58}"),
        "grave" => Some("\u{0060}"),
        "gscr" => Some("\u{210A}"),
        "gsim" => Some("\u{2273}"),
        "gsime" => Some("\u{2A8E}"),
        ...
        "hellip" => Some("\u{2026}"),
        "hercon" => Some("\u{22B9}"),
        "hfr" => Some("\u{1D525}"), // "hfr" => Some("\u{D835}\u{DD25}"),
        ...
        "hopf" => Some("\u{1D559}"), // "hopf" => Some("\u{D835}\u{DD59}"),
        "horbar" => Some("\u{2015}"),
        "hscr" => Some("\u{1D4BD}"), // "hscr" => Some("\u{D835}\u{DCBD}"),
        "hslash" => Some("\u{210F}"),
        "hstrok" => Some("\u{0127}"),
        "hybull" => Some("\u{2043}"),
        "hyphen" => Some("\u{2010}"),
        ...
        "iexcl" => Some("\u{00A1}"),
        "iff" => Some("\u{21D4}"),
        "ifr" => Some("\u{1D526}"), // "ifr" => Some("\u{D835}\u{DD26}"),
        "igrave" => Some("\u{00EC}"),
        "ii" => Some("\u{2148}"),
        "iiiint" => Some("\u{2A0C}"),
        "iiint" => Some("\u{222D}"),
        ...
        "iocy" => Some("\u{0451}"),
        "iogon" => Some("\u{012F}"),
        "iopf" => Some("\u{1D55A}"), // "iopf" => Some("\u{D835}\u{DD5A}"),
        "iota" => Some("\u{03B9}"),
        "iprod" => Some("\u{2A3C}"),
        "iquest" => Some("\u{00BF}"),
        "iscr" => Some("\u{1D4BE}"), // "iscr" => Some("\u{D835}\u{DCBE}"),
        "isin" => Some("\u{2208}"),
        "isinE" => Some("\u{22F9}"),
        "isindot" => Some("\u{22F5}"),
        "isins" => Some("\u{22F4}"),
        ...
        "jcirc" => Some("\u{0135}"),
        "jcy" => Some("\u{0439}"),
        "jfr" => Some("\u{1D527}"), // "jfr" => Some("\u{D835}\u{DD27}"),
        "jmath" => Some("\u{0237}"),
        "jopf" => Some("\u{1D55B}"), // "jopf" => Some("\u{D835}\u{DD5B}"),
        "jscr" => Some("\u{1D4BF}"), // "jscr" => Some("\u{D835}\u{DCBF}"),
        "jsercy" => Some("\u{0458}"),
        "jukcy" => Some("\u{0454}"),
        "kappa" => Some("\u{03BA}"),
        "kappav" => Some("\u{03F0}"),
        "kcedil" => Some("\u{0137}"),
        "kcy" => Some("\u{043A}"),
        "kfr" => Some("\u{1D528}"), // "kfr" => Some("\u{D835}\u{DD28}"),
        "kgreen" => Some("\u{0138}"),
        "khcy" => Some("\u{0445}"),
        "kjcy" => Some("\u{045C}"),
        "kopf" => Some("\u{1D55C}"), // "kopf" => Some("\u{D835}\u{DD5C}"),
        "kscr" => Some("\u{1D4C0}"), // "kscr" => Some("\u{D835}\u{DCC0}"),
        "lAarr" => Some("\u{21DA}"),
        "lArr" => Some("\u{21D0}"),
        "lAtail" => Some("\u{291B}"),
        "lBarr" => Some("\u{290E}"),
        ...
        "lfisht" => Some("\u{297C}"),
        "lfloor" => Some("\u{230A}"),
        "lfr" => Some("\u{1D529}"), // "lfr" => Some("\u{D835}\u{DD29}"),
        "lg" => Some("\u{2276}"),
        "lgE" => Some("\u{2A91}"),
        "lhard" => Some("\u{21BD}"),
        "lharu" => Some("\u{21BC}"),
        ...
        "lopar" => Some("\u{2985}"),
        "lopf" => Some("\u{1D55D}"), // "lopf" => Some("\u{D835}\u{DD5D}"),
        "loplus" => Some("\u{2A2D}"),
        "lotimes" => Some("\u{2A34}"),
        "lowast" => Some("\u{2217}"),
        "lowbar" => Some("\u{005F}"),
        ...
        "lrtri" => Some("\u{22BF}"),
        "lsaquo" => Some("\u{2039}"),
        "lscr" => Some("\u{1D4C1}"), // "lscr" => Some("\u{D835}\u{DCC1}"),
        "lsh" => Some("\u{21B0}"),
        "lsim" => Some("\u{2272}"),
        "lsime" => Some("\u{2A8D}"),
        "lsimg" => Some("\u{2A8F}"),
        ...
        "mfr" => Some("\u{1D52A}"), // "mfr" => Some("\u{D835}\u{DD2A}"), // \u{1D52A}
        "mho" => Some("\u{2127}"),
        "micro" => Some("\u{00B5}"),
        "mid" => Some("\u{2223}"),
        "midast" => Some("\u{002A}"),
        ...
        "mnplus" => Some("\u{2213}"),
        "models" => Some("\u{22A7}"),
        "mopf" => Some("\u{1D55E}"), // "mopf" => Some("\u{D835}\u{DD5E}"),
        "mp" => Some("\u{2213}"),
        "mscr" => Some("\u{1D4C2}"), // "mscr" => Some("\u{D835}\u{DCC2}"),
        "mstpos" => Some("\u{223E}"),
        "mu" => Some("\u{03BC}"),
        ...
        "nexist" => Some("\u{2204}"),
        "nexists" => Some("\u{2204}"),
        "nfr" => Some("\u{1D52B}"), // "nfr" => Some("\u{D835}\u{DD2B}"),
        ...
        "nltrie" => Some("\u{22EC}"),
        "nmid" => Some("\u{2224}"),
        "nopf" => Some("\u{1D55F}"), // "nopf" => Some("\u{D835}\u{DD5F}"),
        "not" => Some("\u{00AC}"),
        "notin" => Some("\u{2209}"),
        ...
        "nscr" => Some("\u{1D4C3}"), // "nscr" => Some("\u{D835}\u{DCC3}"),
        ...
        "oelig" => Some("\u{0153}"),
        "ofcir" => Some("\u{29BF}"),
        "ofr" => Some("\u{1D52C}"), // "ofr" => Some("\u{D835}\u{DD2C}"),
        "ogon" => Some("\u{02DB}"),
        "ograve" => Some("\u{00F2}"),
        "ogt" => Some("\u{29C1}"),
        "ohbar" => Some("\u{29B5}"),
        ...
        "omid" => Some("\u{29B6}"),
        "ominus" => Some("\u{2296}"),
        "oopf" => Some("\u{1D560}"), // "oopf" => Some("\u{D835}\u{DD60}"),
        "opar" => Some("\u{29B7}"),
        "operp" => Some("\u{29B9}"),
        "oplus" => Some("\u{2295}"),
        "or" => Some("\u{2228}"),
        ...
        "perp" => Some("\u{22A5}"),
        "pertenk" => Some("\u{2031}"),
        "pfr" => Some("\u{1D52D}"), // "pfr" => Some("\u{D835}\u{DD2D}"),
        "phi" => Some("\u{03C6}"),
        "phiv" => Some("\u{03D5}"),
        "phmmat" => Some("\u{2133}"),
        "phone" => Some("\u{260E}"),
        ...
        "popf" => Some("\u{1D561}"), // "popf" => Some("\u{D835}\u{DD61}"),
        "pound" => Some("\u{00A3}"),
        "pr" => Some("\u{227A}"),
        "prE" => Some("\u{2AB3}"),
        "prap" => Some("\u{2AB7}"),
        ...
        "prsim" => Some("\u{227E}"),
        "prurel" => Some("\u{22B0}"),
        "pscr" => Some("\u{1D4C5}"), // "pscr" => Some("\u{D835}\u{DCC5}"),
        "psi" => Some("\u{03C8}"),
        "puncsp" => Some("\u{2008}"),
        "qfr" => Some("\u{1D52E}"), // "qfr" => Some("\u{D835}\u{DD2E}"),
        "qint" => Some("\u{2A0C}"),
        "qopf" => Some("\u{1D562}"), // "qopf" => Some("\u{D835}\u{DD62}"),
        "qprime" => Some("\u{2057}"),
        "qscr" => Some("\u{1D4C6}"), // "qscr" => Some("\u{D835}\u{DCC6}"),
        ...
        "rfisht" => Some("\u{297D}"),
        "rfloor" => Some("\u{230B}"),
        "rfr" => Some("\u{1D52F}"), // "rfr" => Some("\u{D835}\u{DD2F}"),
        "rhard" => Some("\u{21C1}"),
        "rharu" => Some("\u{21C0}"),
        "rharul" => Some("\u{296C}"),
        "rho" => Some("\u{03C1}"),
        ...
        "robrk" => Some("\u{27E7}"),
        "ropar" => Some("\u{2986}"),
        "ropf" => Some("\u{1D563}"), // "ropf" => Some("\u{D835}\u{DD63}"),
        "roplus" => Some("\u{2A2E}"),
        "rotimes" => Some("\u{2A35}"),
        "rpar" => Some("\u{0029}"),
        "rpargt" => Some("\u{2994}"),
        ...
        "rrarr" => Some("\u{21C9}"),
        "rsaquo" => Some("\u{203A}"),
        "rscr" => Some("\u{1D4C7}"), // "rscr" => Some("\u{D835}\u{DCC7}"),
        "rsh" => Some("\u{21B1}"),
        "rsqb" => Some("\u{005D}"),
        "rsquo" => Some("\u{2019}"),
        "rsquor" => Some("\u{2019}"),
        ...
        "setmn" => Some("\u{2216}"),
        "sext" => Some("\u{2736}"),
        "sfr" => Some("\u{1D530}"), // "sfr" => Some("\u{D835}\u{DD30}"),
        "sfrown" => Some("\u{2322}"),
        "sharp" => Some("\u{266F}"),
        "shchcy" => Some("\u{0449}"),
        "shcy" => Some("\u{0448}"),
        ...
        "solb" => Some("\u{29C4}"),
        "solbar" => Some("\u{233F}"),
        "sopf" => Some("\u{1D564}"), // "sopf" => Some("\u{D835}\u{DD64}"),
        "spades" => Some("\u{2660}"),
        ...
        "squf" => Some("\u{25AA}"),
        "srarr" => Some("\u{2192}"),
        "sscr" => Some("\u{1D4C8}"), // "sscr" => Some("\u{D835}\u{DCC8}"),
        "ssetmn" => Some("\u{2216}"),
        "ssmile" => Some("\u{2323}"),
        "sstarf" => Some("\u{22C6}"),
        "star" => Some("\u{2606}"),
        ...
        "tdot" => Some("\u{20DB}"),
        "telrec" => Some("\u{2315}"),
        "tfr" => Some("\u{1D531}"), // "tfr" => Some("\u{D835}\u{DD31}"),
        "there4" => Some("\u{2234}"),
        "therefore" => Some("\u{2234}"),
        "theta" => Some("\u{03B8}"),
        ...
        "topbot" => Some("\u{2336}"),
        "topcir" => Some("\u{2AF1}"),
        "topf" => Some("\u{1D565}"), // "topf" => Some("\u{D835}\u{DD65}"),
        "topfork" => Some("\u{2ADA}"),
        "tosa" => Some("\u{2929}"),
        "tprime" => Some("\u{2034}"),
        "trade" => Some("\u{2122}"),
        ...
        "tscr" => Some("\u{1D4C9}"), // "tscr" => Some("\u{D835}\u{DCC9}"),
        "tscy" => Some("\u{0446}"),
        "tshcy" => Some("\u{045B}"),
        "tstrok" => Some("\u{0167}"),
        "twixt" => Some("\u{226C}"),
        ...
        "udhar" => Some("\u{296E}"),
        "ufisht" => Some("\u{297E}"),
        "ufr" => Some("\u{1D532}"), // "ufr" => Some("\u{D835}\u{DD32}"),
        "ugrave" => Some("\u{00F9}"),
        "uharl" => Some("\u{21BF}"),
        "uharr" => Some("\u{21BE}"),
        "uhblk" => Some("\u{2580}"),
        ...
        "uml" => Some("\u{00A8}"),
        "uogon" => Some("\u{0173}"),
        "uopf" => Some("\u{1D566}"), //  "uopf" => Some("\u{D835}\u{DD66}"),
        "uparrow" => Some("\u{2191}"),
        "updownarrow" => Some("\u{2195}"),
        ...
        "uring" => Some("\u{016F}"),
        "urtri" => Some("\u{25F9}"),
        "uscr" => Some("\u{1D4CA}"), // "uscr" => Some("\u{D835}\u{DCCA}"),
        "utdot" => Some("\u{22F0}"),
        "utilde" => Some("\u{0169}"),
        "utri" => Some("\u{25B5}"),
        "utrif" => Some("\u{25B4}"),
        ...
        "verbar" => Some("\u{007C}"),
        "vert" => Some("\u{007C}"),
        "vfr" => Some("\u{1D533}"), //  "vfr" => Some("\u{D835}\u{DD33}"),
        "vltri" => Some("\u{22B2}"),
        "vnsub" => Some("\u{2282}\u{20D2}"),
        "vnsup" => Some("\u{2283}\u{20D2}"),
        "vopf" => Some("\u{1D567}"), // "vopf" => Some("\u{D835}\u{DD67}"),
        "vprop" => Some("\u{221D}"),
        "vrtri" => Some("\u{22B3}"),
        "vscr" => Some("\u{1D4CB}"), // "vscr" => Some("\u{D835}\u{DCCB}"),
        ...
        "wedgeq" => Some("\u{2259}"),
        "weierp" => Some("\u{2118}"),
        "wfr" => Some("\u{1D534}"),  // "wfr" => Some("\u{D835}\u{DD34}"),
        "wopf" => Some("\u{1D568}"), // "wopf" => Some("\u{D835}\u{DD68}"),
        "wp" => Some("\u{2118}"),
        "wr" => Some("\u{2240}"),
        "wreath" => Some("\u{2240}"),
        "wscr" => Some("\u{1D4CC}"), // "wscr" => Some("\u{D835}\u{DCCC}"),
        "xcap" => Some("\u{22C2}"),
        "xcirc" => Some("\u{25EF}"),
        "xcup" => Some("\u{22C3}"),
        "xdtri" => Some("\u{25BD}"),
        "xfr" => Some("\u{1D535}"), // "xfr" => Some("\u{D835}\u{DD35}"),
        "xhArr" => Some("\u{27FA}"),
        "xharr" => Some("\u{27F7}"),
        "xi" => Some("\u{03BE}"),
        "xlArr" => Some("\u{27F8}"),
        ...
        "xnis" => Some("\u{22FB}"),
        "xodot" => Some("\u{2A00}"),
        "xopf" => Some("\u{1D569}"), // "xopf" => Some("\u{D835}\u{DD69}"),
        "xoplus" => Some("\u{2A01}"),
        "xotime" => Some("\u{2A02}"),
        "xrArr" => Some("\u{27F9}"),
        "xrarr" => Some("\u{27F6}"),
        "xscr" => Some("\u{1D4CD}"), // "xscr" => Some("\u{D835}\u{DCCD}"),
        "xsqcup" => Some("\u{2A06}"),
        "xuplus" => Some("\u{2A04}"),
        "xutri" => Some("\u{25B3}"),
        "xvee" => Some("\u{22C1}"),
        ...
        "ycy" => Some("\u{044B}"),
        "yen" => Some("\u{00A5}"),
        "yfr" => Some("\u{1D536}"), // "yfr" => Some("\u{D835}\u{DD36}"),
        "yicy" => Some("\u{0457}"),
        "yopf" => Some("\u{1D56A}"), // "yopf" => Some("\u{D835}\u{DD6A}"),
        "yscr" => Some("\u{1D4CE}"), // "yscr" => Some("\u{D835}\u{DCCE}"),
        "yucy" => Some("\u{044E}"),
        "yuml" => Some("\u{00FF}"),
        "zacute" => Some("\u{017A}"),
        "zcaron" => Some("\u{017E}"),
        ...
        "zeetrf" => Some("\u{2128}"),
        "zeta" => Some("\u{03B6}"),
        "zfr" => Some("\u{1D537}"), // "zfr" => Some("\u{D835}\u{DD37}"),
        "zhcy" => Some("\u{0436}"),
        "zigrarr" => Some("\u{21DD}"),
        "zopf" => Some("\u{1D56B}"), // "zopf" => Some("\u{D835}\u{DD6B}"),
        "zscr" => Some("\u{1D4CF}"), // "zscr" => Some("\u{D835}\u{DCCF}"),
        "zwj" => Some("\u{200D}"),
        "zwnj" => Some("\u{200C}"),
        _ => None,
    }
